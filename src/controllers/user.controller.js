...
const updateUserCover = asyncHandler(async(req,res) =>{
 ...
 const user =  await User.findByIdAndUpdate(
   ...
   return res
   .status(200)
   .json(new ApiResponse(200,user,"CoverImage is updated succesfully"))
})
...
export { registerUser,loginUser,logoutUser,refreshAccessToken,changCurrentPassword,getCurrentUser,updateAccountDetails,updateUserAvatar,updateUserCover,getUserChannelProfile,getWatchHistory }